...
This section is meant to be read as a two-step narrative:

1. Figure 1 shows why similarity-based authentication can fail under strong counterfeit attacks.
2. Figure 2 shows the proposed diffusion-based pipeline that addresses this failure mode.
...
<Wide>
  <Figure>
    <Picture
      slot="figure"
      src={scheme}
      alt="Proposed diffusion-based authentication pipeline with class-conditioned noise prediction"
    />
    <Fragment slot="caption">
      Proposed solution: class-conditioned denoising turns reconstruction quality into a robust authentication decision signal.
    </Fragment>
  </Figure>
</Wide>
